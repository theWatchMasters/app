    ...
    en: {
      translation: {
        error: {
          ...
          '2fa_not_initiated':
            '2FA enrollment has not been initiated for this account',
          invalid_mfa_code: 'The 2FA code is invalid',
          invalid_or_expired_token:
            'The authentication token is invalid or has expired. Try logging in again.',
          active_task_exists:
            'You already have an active task. Please submit proof or forfeit it before starting a new one.',
          invalid_fields:
        ...
        mfa_register: {
          headings: {
            text1: 'Set up 2FA',
            text2:
              'Click the button below to enroll in 2FA with your authenticator app. Alternatively, you can scan the QR code <1>with another device</1> to enroll with 2FA on that device.',
        ...
        mfa_register_code: {
          headings: {
            text2:
              'Enter the 6-digit code generated by your authenticator app to complete enrollment',
            code: 'Code',
          },
          placeholders: {
            code: '000000',
